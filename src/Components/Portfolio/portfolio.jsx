        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              <h2 className="section-heading text-uppercase">OUR JOURNEY & INTEREST</h2>
              <h3 className="section-subheading text-muted">More inspiring and become a trendsetter.</h3>
            </div>
          </div>
          <div className="row">
            {
